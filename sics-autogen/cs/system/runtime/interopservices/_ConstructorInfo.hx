...
@:nativeGen @:abstract @:libType @:csNative @:native("System.Runtime.InteropServices._ConstructorInfo") extern interface _ConstructorInfo {
	...
	function Invoke_2(obj : Dynamic, invokeAttr : cs.system.reflection.BindingFlags, binder : cs.system.reflection.Binder, parameters : cs.NativeArray<Dynamic>, culture : cs.system.globalization.CultureInfo) : Dynamic;
	function Invoke_3(obj : Dynamic, parameters : cs.NativeArray<Dynamic>) : Dynamic;
	function Invoke_4(invokeAttr : cs.system.reflection.BindingFlags, binder : cs.system.reflection.Binder, parameters : cs.NativeArray<Dynamic>, culture : cs.system.globalization.CultureInfo) : Dynamic;
	function Invoke_5(parameters : cs.NativeArray<Dynamic>) : Dynamic;
