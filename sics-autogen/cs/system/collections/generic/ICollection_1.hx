...
@:nativeGen @:abstract @:libType @:csNative @:native("System.Collections.Generic.ICollection`1") extern interface ICollection_1<T0> extends IEnumerable_1<T0> extends cs.system.collections.IEnumerable {
