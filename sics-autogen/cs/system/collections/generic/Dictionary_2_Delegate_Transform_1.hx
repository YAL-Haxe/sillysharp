...
@:nativeGen @:libType @:csNative @:native("System.Collections.Generic.Dictionary`2.Transform`1") extern final class Dictionary_2_Delegate_Transform_1<T0,T1,T2> extends cs.system.MulticastDelegate {
