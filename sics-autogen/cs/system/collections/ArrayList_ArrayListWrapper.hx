...
@:nativeGen @:libType @:csNative @:native("System.Collections.ArrayList.ArrayListWrapper") extern class ArrayList_ArrayListWrapper extends ArrayList {
	...
	private var m_InnerArrayList : ArrayList;
