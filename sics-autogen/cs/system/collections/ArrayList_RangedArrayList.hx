...
@:nativeGen @:libType @:csNative @:native("System.Collections.ArrayList.RangedArrayList") extern final class ArrayList_RangedArrayList extends ArrayList_ArrayListWrapper {
	var Capacity(get,set) : Int;
	var Count(get,never) : Int;
	var IsSynchronized(get,never) : Bool;
	function new(innerList : ArrayList, index : Int, count : Int) : Void;
