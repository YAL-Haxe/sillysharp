...
@:nativeGen @:libType @:csNative @:native("System.Collections.ArrayList.SynchronizedArrayListWrapper") extern final class ArrayList_SynchronizedArrayListWrapper extends ArrayList_ArrayListWrapper {
