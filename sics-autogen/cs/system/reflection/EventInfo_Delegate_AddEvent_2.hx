...
@:nativeGen @:libType @:csNative @:native("System.Reflection.EventInfo.AddEvent`2") extern final class EventInfo_Delegate_AddEvent_2<T0,T1> extends cs.system.MulticastDelegate {
